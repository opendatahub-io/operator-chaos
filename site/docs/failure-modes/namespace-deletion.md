...
|-------|------|----------|---------|-------------|
| `namespace` | `string` | Yes | - | Name of the namespace to delete |
...
|-----------|------------|--------|-------------|
| odh-model-controller | odh-model-controller-namespace-deletion | high | When the operator's namespace is deleted, the operator should detect the loss an... |
