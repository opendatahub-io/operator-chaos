...
|-------|------|----------|---------|-------------|
| `quotaName` | `string` | Yes | - | Name for the ResourceQuota to create |
| `cpu` | `string` | No | - | CPU limit (e.g., '100m', '1') |
| `memory` | `string` | No | - | Memory limit (e.g., '128Mi', '1Gi') |
| `pods` | `string` | No | - | Maximum number of pods (e.g., '0', '5') |
