...
| Component | CRDMutation | ClientFault | ConfigDrift | FinalizerBlock | NetworkPartition | OwnerRefOrphan | PodKill | QuotaExhaustion | RBACRevoke | WebhookDisrupt | WebhookLatency | Total |
|-----------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------|
...
| odh-model-controller | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | :material-check: | 11 |
