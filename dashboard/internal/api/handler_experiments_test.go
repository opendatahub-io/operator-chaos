...
func (m *mockStore) Trends(since *time.Time) (store.TrendStats, error) { return store.TrendStats{}, nil }
func (m *mockStore) VerdictTimeline(days int) ([]store.DayVerdicts, error) { return nil, nil }
